...
```sh
  cd my-folder
  git clone https://github.com/Kaghenimbale/blog-app
```
...
Feel free to check the [issues page](https://github.com/Kaghenimbale/blog-app/issues).
...
This project is [MIT](https://github.com/Kaghenimbale/blog-app/blob/main/LICENSE) licensed.
